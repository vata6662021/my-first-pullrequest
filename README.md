...
Вуди Аллен
Если что-то может пойти не так, оно пойдёт не так. Murphy's Law.
...
Если жизнь тебя еб*т, значит у нее встаёт, значит ты ей нравишься, так чего ты паришься?

> **Один важный секрет: нужно идти туда, куда хочется, а не туда, куда якобы "надо".**  (c) Макс Фрай
**"Ум заключается не только в знании, но и в умении прилагать знание на деле."** (c) Аристотель
